...
function theme_custom_admin_footer() {
	_e( '<span id="footer-thankyou">Developed by <a href="https://dig.id" target="_blank">dig.id</a></span>.', 'carina' );
}
...
function theme_login_logo() {
	...
	h1 a {
		background-image: url(' . get_template_directory_uri() . '/assets/svg/carinazermatt-logo.png) !important;
