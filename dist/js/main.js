...
/* harmony export */   carinaInitAccordionsSingleGsapSeq: () => (/* binding */ carinaInitAccordionsSingleGsapSeq)
/* harmony export */ });
...
function carinaInitAccordionsSingleGsapSeq() {
  ...
  document.querySelectorAll('[data-accordion="single"]').forEach(function (group) {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 3:
                locked = true;
                _context.prev = 4;
                currentOpen = group.querySelector("details[open]"); // If clicking the same open item => just close it
                if (!(currentOpen === d)) {
                  _context.next = 11;
                  break;
                }
                _context.next = 9;
                return closeDetails(currentOpen);
              case 9:
                locked = false;
                return _context.abrupt("return");
              case 11:
    ...
    function closeDetails(detailsEl) {
      var panel = detailsEl.querySelector("[data-accordion-panel]");
      if (!panel) {
        detailsEl.open = false;
        return Promise.resolve();
      }
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].killTweensOf(panel);
      if (reduce) {
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(panel, {
          height: 0,
          opacity: 0
    ...
    function openDetails(detailsEl) {
      ...
      var startH = panel.offsetHeight || 0; // 0 when closed
      return new Promise(function (resolve) {
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].fromTo(panel, {
          height: startH,
          opacity: 0.001
        }, {
          height: "auto",
...
(function (_history$state) {
  var grid = document.getElementById('blog-grid');
  var pager = document.getElementById('blog-pager');
  var number = document.getElementById('blog-current');
  var section = document.getElementById('section-blog');
  if (!grid || !pager || !number || !section) return;
  var q = function q(sel) {
    var root = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document;
    return root.querySelector(sel);
  };
  var parsePageFromHref = function parsePageFromHref(href) {
  ...
  var parsePageFromData = function parsePageFromData(btn) {
  ...
  var setBtnState = function setBtnState(btn, enabled, href, page) {
    if (!btn) return;
  ...
  var updatePagerFromPayload = function updatePagerFromPayload(p) {
    var prev = q('.pager-prev', pager);
    var next = q('.pager-next', pager);
  ...
  var getHeaderOffset = function getHeaderOffset() {
    var candidates = document.querySelectorAll('header[role="banner"], .site-header, .header, #site-header');
    var h = 0;
  ...
  var waitForImages = function waitForImages(root) {
    var timeout = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 800;
    return new Promise(function (resolve) {
      var imgs = _toConsumableArray(root.querySelectorAll('img')).filter(function (img) {
        return !img.complete;
      });
      if (!imgs.length) return requestAnimationFrame(function () {
        return resolve();
      });
  ...
  var scrollToIntroAfterLayout = function scrollToIntroAfterLayout() {
    var intro = document.querySelector('#section-intro, .section-intro');
    if (!intro) return;
    var offset = getHeaderOffset() + 8;
    requestAnimationFrame(function () {
      requestAnimationFrame(function () {
        var y = Math.max(0, intro.getBoundingClientRect().top + window.scrollY - offset);
        window.scrollTo({
          top: y,
          behavior: 'smooth'
        });
  ...
  var buildPrettyUrl = function buildPrettyUrl(page) {
    if (page === 1) {
  ...
  var ajax = function ajax(page) {
    ...
    return fetch(CARINA_BLOG.ajax_url, {
      ...
      var prettyUrl = buildPrettyUrl(p.current);
      history.pushState({
        page: p.current
      }, '', prettyUrl);
      ...
      var fallbackUrl = buildPrettyUrl(page);
  ...
  document.addEventListener('click', function (e) {
    ...
    if (/admin-ajax\.php/i.test(href)) {
      ...
      var page = parsePageFromHref(href) || 1;
      ajax(page);
    }
  }, {
    capture: true
  ...
  window.addEventListener('popstate', function (e) {
    var page = e.state && typeof e.state.page !== 'undefined' ? parseInt(e.state.page, 10) : parsePageFromHref(window.location.href) || 1;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.addEventListener("load", function () {
    ...
    if (document.body.classList.contains("single")) {
      _fancyapps_ui__WEBPACK_IMPORTED_MODULE_0__.Fancybox.bind('[data-fancybox=open-zimmer]', {
        defaultType: "iframe",
        id: "open-zimmer"
      });
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   carinaInitLenisCinematic: () => (/* binding */ carinaInitLenisCinematic)
/* harmony export */ });
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
...
var carinaEaseExpoOut = function carinaEaseExpoOut(t) {
 ...
 */
function carinaInitLenisCinematic() {
  var carinaLenis = new lenis__WEBPACK_IMPORTED_MODULE_2__["default"]({
    duration: 1.35,
  ...
  carinaLenis.on("scroll", gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.update);
...
var carinaLenis = carinaInitLenisCinematic();

// Smooth scroll for "scroll down" button on home page
document.addEventListener("DOMContentLoaded", function () {
  var isHome = !!document.querySelector(".page-template-page-home");
  if (isHome) {
    var _document$querySelect;
    (_document$querySelect = document.querySelector(".btn-scroll")) === null || _document$querySelect === void 0 || _document$querySelect.addEventListener("click", function (e) {
      e.preventDefault();
  ...
  var fixedButton = document.querySelector(".fixed-booking-button");
  if (fixedButton) {
    var triggerPosition = 40; // px from top
    var isVisible = false;

    // Prepare initial hidden state
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(fixedButton, {
      autoAlpha: 0,
      y: 50
    });

    // Listen to Lenis scroll on the instance
    carinaLenis.on("scroll", function (_ref) {
      var scroll = _ref.scroll;
      var shouldShow = scroll > triggerPosition;
      if (shouldShow === isVisible) return; // no-op if unchanged
      isVisible = shouldShow;
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(fixedButton, {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _fancybox__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fancybox */ "./assets/js/fancybox.js");
...
/* harmony import */ var _sticky_header__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sticky-header */ "./assets/js/sticky-header.js");
/* harmony import */ var _sticky_header__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_sticky_header__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _accordion__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./accordion */ "./assets/js/accordion.js");
/* harmony import */ var _blog_pagination__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./blog-pagination */ "./assets/js/blog-pagination.js");
/* harmony import */ var _blog_pagination__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_blog_pagination__WEBPACK_IMPORTED_MODULE_6__);
...
document.addEventListener('DOMContentLoaded', function () {
  var btn = document.querySelector('.carina-newsletter .carina-btn');
  if (!btn) return;
  var lang = document.documentElement.lang || '';
  if (lang.startsWith('fr')) btn.value = 'Envoyer';else if (lang.startsWith('en')) btn.value = 'Send';else btn.value = 'Senden';
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   carinaInitOffcanvasMenuGsap: () => (/* binding */ carinaInitOffcanvasMenuGsap)
/* harmony export */ });
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
...
function carinaInitOffcanvasMenuGsap() {
  // trigger and wrapper
  var btn = document.querySelector(".menu-toggle__button");
  var wrap = document.querySelector(".menu-offcanvas"); // allow both
  if (!btn || !wrap) return;

  // columns of the mega menu (preferred via data attribute)
  var cols = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.toArray(wrap.querySelectorAll("[data-menu-col]"));
  ...
  if (!cols.length) {
    ...
    cols = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.toArray(wrap.querySelectorAll('[class*="col-span-"]'));
  }
  var targets = [document.body, document.documentElement];
  var prefersReduced = window.matchMedia("(prefers-reduced-motion: reduce)").matches;
  var polygonStart = "polygon(30% 0, 70% 0, 100% 0, 0 0)"; // initial clip-path (matches CSS)
  var polygonMid = "polygon(0 100%, 70% 0, 100% 0, 0 0)"; // intermediate clip-path (bottom-left corner down)
  var polygonEnd = "polygon(0 100%, 100% 100%, 100% 0, 0 0)"; // final clip-path (fully open)

  // initial states
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(wrap, {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(cols, {
    autoAlpha: 0,
    y: -20
  });
  cols.forEach(function (col) {
    return gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(col.querySelectorAll("li"), {
      autoAlpha: 0,
      y: -10
    });
  });
  ...
  var carinaAllItems = cols.flatMap(function (col) {
    return Array.from(col.querySelectorAll("li"));
  });
  if (carinaAllItems.length) {
    tl.fromTo(carinaAllItems, {
      autoAlpha: 0,
      y: -8
    }, {
      autoAlpha: 1,
  ...
  var carinaPlayOpen = function carinaPlayOpen() {
    btn.classList.add("menu-open");
    btn.setAttribute("aria-expanded", "true");
    targets.forEach(function (el) {
      return el.classList.add("menu-open");
    });
  ...
  var carinaPlayClose = function carinaPlayClose() {
  ...
  btn.addEventListener("click", function () {
    var isOpen = btn.classList.contains("menu-open");
  ...
  document.addEventListener("click", function (e) {
    var inside = e.target.closest(".menu-toggle__button") || e.target.closest(".menu-offcanvas");
...
(function carinaStickyHeaderIIFE() {
  ...
  var footer = document.querySelector(cfg.footerSelector);

  // --- Threshold (avoid mixing ?? with ||) ---------------------------------
  var dynamicThreshold = Number.isFinite(cfg.threshold) ? Number(cfg.threshold) : header && header.getBoundingClientRect().height || 64;

  // State
  var lastY = 0;
  var lastDir = 0; // -1 up, +1 down
  var ticking = false;

  // Footer fallback state (when no IO support)
  var footerTopAbs = null;
  var useFooterFallback = false;

  // Helpers
  var clampY = function clampY(y) {
    return Math.max(0, y | 0);
  };
  function carinaApplyState(y) {
    var atTop = y <= cfg.topEpsilon;
    var beyond = y > dynamicThreshold;
  ...
  function carinaMeasure() {
    if (!Number.isFinite(cfg.threshold)) {
      var h = header && header.getBoundingClientRect().height;
  ...
  if (footer && "IntersectionObserver" in window) {
    ...
    var io = new IntersectionObserver(function (entries) {
      ...
      rootMargin: "0px 0px -".concat(cfg.footerTriggerMargin, "px 0px")
    });
    io.observe(footer);
  } else if (footer) {
  ...
  function carinaUpdate(yRaw) {
    var y = Number.isFinite(yRaw) ? clampY(yRaw) : clampY(window.scrollY || window.pageYOffset || 0);
    carinaApplyState(y);
    ...
    if (useFooterFallback && footerTopAbs != null) {
      var viewBottom = y + (window.innerHeight || document.documentElement.clientHeight || 0);
      var near = viewBottom >= footerTopAbs - cfg.footerTriggerMargin;
      body.classList.toggle("at-footer", !!near);
    }
    ticking = false;
  }
  function carinaOnScroll(yFromAdapter) {
    if (!ticking) {
      ...
      window.requestAnimationFrame(function () {
        return carinaUpdate(yFromAdapter);
      });
    }
  }
  ...
  if (window.lenis && typeof window.lenis.on === "function") {
    window.lenis.on("scroll", function (_ref) {
      var scroll = _ref.scroll;
      return carinaOnScroll(scroll);
    });
  }
...
window.addEventListener("load", function () {
  if (document.querySelector(".page-template-page-home")) {
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.slider-banner-swiper', {
      slidesPerView: 1,
      loop: true,
      speed: 900,
      autoplay: {
  ...
  if (document.querySelector(".page-template-page-taste")) {
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.bleed-right-swiper', {
      speed: 900,
      loop: true,
      autoplay: {
        delay: 5000,
  ...
  if (document.querySelector(".page-template-page-relax")) {
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.bleed-both-swiper', {
      speed: 900,
      loop: true,
  ...
  if (document.querySelector(".page-template-page-carina-spirit")) {
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.history-slider', {
      speed: 900,
      loop: true,
      autoplay: {
        delay: 5000,
    ...
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-testimonials', {
      slidesPerView: 1.3,
      spaceBetween: 10,
      grabCursor: true,
      speed: 1200,
  ...
  if (document.querySelector(".single-zimmer") || document.querySelector(".single-apartment")) {
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.rooms-slider', {
      speed: 900,
      loop: true,
      autoplay: {
        delay: 5000,
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkdigid"] = self["webpackChunkdigid"] || [];
