	...
	<div class="theme-container">
		<div class="theme-grid">
			...
			<div class="mb-4 col-span-2 md:col-span-6 xl:col-span-12">
				<h2 class="title-sm"><?php the_field( 'apartment_content_over_title', 'options' ); ?></h2>
			</div>
			<!-- Section heading -->
			<div class="mb-8 md:mb-16 xl:mb-7 col-span-2 md:col-span-6 xl:col-span-7">
				<p class="title-md md:max-w-[530px] xl:max-w-[530px]"><?php the_field( 'apartment_content_title', 'options' ); ?></p>
			</div>
		</div>
