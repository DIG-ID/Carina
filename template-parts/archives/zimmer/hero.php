<section id="section-hero" class="section-hero relative h-screen w-full z-20">
  <?php if ( get_field('room_hero_background_image', 'options') ) : ?>
    <?php echo wp_get_attachment_image(
      get_field('room_hero_background_image', 'options'),
      'full',
      false,
      [
  ...
  <div class="theme-container justify-center h-full flex items-end pb-36 xl:pb-20 relative z-10">
    <div class="theme-grid">
      <?php if( get_field('room_hero_title', 'options') ) : ?>
      <div class="col-span-2 md:col-span-<?php echo get_field( 'room_hero_cols_md', 'options' ); ?> xl:col-span-<?php echo get_field( 'room_hero_cols_xl', 'options'); ?> text-lightGrey">
        <p class="title-xl">
          <?php the_field( 'room_hero_title', 'options'); ?>
        </p>
        <h1 class="block-30 mt-4">
							<?php the_field( 'room_hero_under_title', 'options' ); ?>
				</h1>
      </div>
      <?php endif; ?>
    </div>
