<section id="section-four-icons" class="section-four-icons relative w-full pt-28 md:pt-36 xl:pt-72 pb-6 xl:pb-48 bg-lightGrey z-0">
    <div class="theme-container">
        ...
        <div class="theme-grid">
            <div class="col-span-2 md:col-span-6 xl:col-span-5 col-start-1 xl:col-start-2">
                <?php
