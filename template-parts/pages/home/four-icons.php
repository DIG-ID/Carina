<section id="section-four-icons" class="section-four-icons relative w-full pt-28 md:pt-16 pb-8 md:pb-24 xl:pb-16 bg-lightGrey z-0">
        ...
        <div class="theme-grid">
            <div class="left-col col-span-2 md:col-span-3 xl:col-span-5 col-start-1 xl:col-start-2">
                ...
                if( have_rows('four_icons_left_list') ):
                    ...
                    <div class="icon-block-wrapper flex flex-row mb-12 md:mb-16 xl:mb-24 items-center xl:min-h-[122px]">
