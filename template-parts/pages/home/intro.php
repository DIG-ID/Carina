<section id="section-intro" class="section-intro relative w-full pt-32 md:pt-36 xl:pt-52 pb-6 xl:pb-48 bg-darkBlue z-10">
    <div class="theme-container">
        ...
        <div class="mx-auto grid grid-cols-2 md:grid-cols-6 xl:grid-cols-[284fr_433fr_284fr] gap-x-8">
