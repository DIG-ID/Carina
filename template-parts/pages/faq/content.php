						...
						if ( have_rows( 'accordion_item' ) ) :
							...
							while ( have_rows( 'accordion_item' ) ) :
								...
								<details id="faq-<?php echo esc_attr( $gi . '-' . $i ); ?>" class="accordion__item group  bg-darkBlue text-lightGrey mb-4">
									<summary class="accordion__item-title flex justify-between items-center cursor-pointer px-9 py-4 [&::-webkit-details-marker]:hidden hover:bg-coral hover:text-lightGrey font-magnatText font-normal text-lg tracking-[0.0003rem] group-open:text-2xl group-open:bg-coral transition-all duration-700 ease-in-out">
									...
									<div class="accordion__item-sub-menu px-9 py-6 overflow-hidden" data-accordion-panel>
										<div class=" font-funnelsans font-normal text-lg text-lightGrey tracking-[0.0003rem]"><?php the_sub_field( 'answer' ); ?></div>
									</div>
								</details>
								<?php
							endwhile;
