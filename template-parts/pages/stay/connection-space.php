<section id="section-connection-space" class="section-connection-space bg-white pt-24 md:pt-24 xl:pt-24 pb-[55px] xl:pb-[150px]">
    <div class="theme-container h-full flex items-end relative z-10 mt-[66px] md:mt-28">
        <div class="theme-grid">
            ...
            <div class="col-start-1 col-span-2 md:col-start-4 md:col-span-3 xl:col-start-8 xl:col-span-5 text-darkBlue">
                <h2 class="title-md mb-[26px] md:mb-[50px] xl:mb-[70px]"><?php echo esc_html( get_field('connection_space_title') ); ?></h2>
                <p class="block-text mb-[36px] md:mb-[27px] xl:max-w-[416px] xl:mb-[235px]"><?php echo esc_html( get_field('connection_space_description') ); ?></p>
                <?php 
