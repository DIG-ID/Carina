<section id="section-banner" class="section-banner relative w-full pb-16 md:pb-24 xl:pb-16">
  <div class="w-full pt-1 pb-0 md:pb-56 lg:pb-56 xl:pb-64 relative">
    ...
    <div class="grid grid-cols-2 md:grid-cols-6 xl:grid-cols-12 gap-x-5 md:gap-x-4 xl:gap-x-0 md:px-7 xl:px-6 md:absolute left-0 bottom-0">
      <div class="col-span-2 md:col-span-5 ld:col-span-4 xl:col-span-6 2xl:col-span-4 col-start-1 md:col-start-2 lg:col-start-3 xl:col-start-7 2xl:col-start-8">
        <div class="bg-lightGrey px-8 md:px-7 xl:px-8 pt-8 pb-2 md:pt-6 xl:pt-9 xl:pb-0 w-full">
          <?php if( get_field( 'banner_title' ) ) : ?>
            <h2 class="title-md text-darkBlue pb-9"><?php the_field( 'banner_title' ); ?></h2>
          <?php endif; ?>
          <?php if( get_field( 'banner_text' ) ) : ?>
            <p class="block-text text-darkBlue md:mb-6"><?php the_field( 'banner_text' ); ?></p>
          <?php endif; ?>
        </div>
      </div>
    </div>
